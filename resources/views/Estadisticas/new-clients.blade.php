        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
            ...
            <form action="{{ route('admin.estadisticas.nuevos-clientes') }}" method="GET" class="mb-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    {{-- Solo se muestra si $nuevosClientesCount está definido Y es mayor que 0 --}}
                    @if(isset($nuevosClientesCount) && $nuevosClientesCount > 0)
                        <a href="{{ route('admin.estadisticas.nuevos-clientes.pdf', [
