    ...
    <div class="col-md-8 col-lg-7">
        ...
        <div class="contact-person mb-4 pb-3 border-bottom"> {{-- Clases de Bootstrap para margen y borde --}}
            ...
            <div class="contact-info ms-3"> {{-- Margen izquierdo con Bootstrap --}}
                ...
                <p class="mb-1"><strong>Teléfono:</strong> [222444455]</p>
                <p class="mb-0"><strong>Correo Electrónico:</strong> <a href="mailto:[Correo del Personal 1]" class="text-info">[mario@mannymaquinarias.com]</a></p> {{-- Clase de Bootstrap para el color del enlace --}}
            </div>
        </div>
        ...
        <div class="contact-person mb-0 pb-0"> {{-- Última persona sin margen inferior ni borde --}}
            ...
            <div class="contact-info ms-3">
                ...
                <p class="mb-1"><strong>Teléfono:</strong> [2224446667]</p>
                <p class="mb-0"><strong>Correo Electrónico:</strong> <a href="mailto:[Correo del Personal 2]" class="text-info">[maria@mannymaquinarias.com]</a></p>
            </div>
        </div>
